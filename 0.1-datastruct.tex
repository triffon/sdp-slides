...
\begin{frame}
  ...
  \begin{itemize}[<+->]
  \item Според вида на компонентите си
    \begin{itemize}[<.->]
...
\begin{frame}
  ...
  \item $f_A(100) = 10300,\quad f_B(100) = 10005$
...
\begin{frame}
  ...
  \begin{center}
    \untitledImageWithAttr{.6\textwidth}{images/big-o.png}{Daniel Miessler}{https://danielmiessler.com/study/big-o-notation/}{\CCBYSA{2.0}}
  \end{center}
\end{frame}
