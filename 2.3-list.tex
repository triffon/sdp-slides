...
\date[28.10--3.11.2019 г.]{28 октомври -- 3 ноември 2019 г.}
...
% TODO: анимация на insertAfter
% TODO: анимация на deleteAfter
\begin{frame}
  ...
  \begin{center}
    \begin{tikzpicture}
      ...
      \pointerto{a0.south}{\tt{front}}{below}
...
\begin{frame}
  ...
  \begin{center}
    ...
    \begin{tikzpicture}
      ...
      % обратен указател
      \draw[pointer] (annext.center) -| ++(3em,2em)  -| ($(a0data.west) - (2em,0)$) |- (a0data.west);

      % указател към началото
      \pointerto{a0.south}{\tt{start}}{below}
    \end{tikzpicture}
  \end{center}
\end{frame}
...
% TODO: слайд за for each
% TODO: слайд за list initialization
