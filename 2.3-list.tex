...
\begin{frame}<1-7| trans:3,6>
  \frametitle{\alt<1-3>{Включване}{Изключване} на елемент \alt<1-3>{в}{от} едносвързан списък}
...
\begin{frame}<1-10| trans:4,9>
  \frametitle{\alt<1-4>{Включване}{Изключване} на елемент \alt<1-4>{в}{от} двусвързан списък}
