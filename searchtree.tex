...
\begin{frame}
  ...
  \begin{definition}[B-дърво]
    B-дърво от ред $n$ наричаме $n$-арно дърво, за което:
    \begin{itemize}
    \item всички листа са еднаква дълбочина
    \item всеки възел съдържа най-много $n-1$ ключа подредени в нарастващ ред
    \item всеки възел с изключение на корена съдържа най-малко $\left\lceil\frac {n-1}2\right\rceil$ ключа
    \item всеки възел с $m$ ключа $(k_1,\ldots,k_m)$ или няма поддървета, или има точно $m+1$  най-леви поддървета $(T_0,\ldots, T_m)$
...
\begin{frame}
  ...
  \item Ако броят на ключовете в листото падне под минимума:
    \begin{itemize}
    \item Опитваме се да заемме ключ и съответно поддърво от някой от двата си съседа
    \item Ако и двата съседа също съдържат минимален брой ключове
      \begin{itemize}
      \item Листото се слива с някой от двата си съседа
      \item Понеже броят на поддърветата в родителя намалява с 1, заемаме ключът който е стоял между двете слети листа
      \item Сигурни сме, че в новото листо броят ключове не надвишава максимума, понеже $2\left\lceil\frac{n-1}2\right\rceil-1 \leq n - 1$
      \end{itemize}
    \end{itemize}
