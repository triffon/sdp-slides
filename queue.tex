...
\begin{frame}
  ...
  \begin{tikzpicture}[remember picture,overlay]
    \foreach \r in {1.5,3.2,...,12}{
      \draw[red,dashed,thick,xshift=21.2em,yshift=14.4em,rotate=45] (-\r em,-\r em) rectangle (\r em, \r em);
    }
  \end{tikzpicture}}
\end{frame}
...
%   \begin{tabular}{|@{}c@{}|@{}c@{}|}
%     \hline
%     \BlackKnightOnWhite & \BlackKnightOnWhite\\
%     \hline
%     \BlackKnightOnWhite & \BlackKnightOnWhite\\
%     \hline
%   \end{tabular}
...
%   \begin{chessboard}{10}{0.5ex}
%     \hline
%     \bks1&\ws  &\ws  &\ws  &\ws  &\ws  &\ws  &\ws  &\ws  &\ws  &\\
%     \hline
%     \ws  &\ws  &\bks2&\ws  &\ws  &\ws  &\ws  &\ws  &\ws  &\ws  &\\
%     \hline
%     \ws  &\bks2&\ws  &\ws  &\ws  &\ws  &\ws  &\ws  &\ws  &\ws  &\\
%     \hline
