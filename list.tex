...
\end{semiverbatim}
\pause
Експлицитното преобразуване на типа се налага, понеже \tt{*this} е от тип \tt{Iterator\&}, а конструкторът за копиране на \tt{ConcreteIterator} очаква тип \tt{ConcreteIterator\&}.
\end{frame}
